...
struct OpenXrProgram : IOpenXrProgram {
    ...
    void InitializeSession() override {
...

        {
            ...
            // 类型是 XrGraphicsBindingOpenGLESAndroidKHR，有GL相关配置
    ...
    void CreateSwapchains() override {
        ...
        Log::Write(Log::Level::Info, Fmt("viewCount : %d", viewCount));
        ...
        if (viewCount > 0) {
            ...
            for (uint32_t i = 0; i < viewCount; i++) {
                ...
                Log::Write(Log::Level::Info, Fmt("xrEnumerateSwapchainImages count : %d", imageCount));
    ...
    bool RenderLayer(XrTime predictedDisplayTime, std::vector<XrCompositionLayerProjectionView>& projectionLayerViews,
        ...
        //Log::Write(Log::Level::Info, Fmt("visualizedSpaces: %d, cubes: %d", m_visualizedSpaces.size(), cubes.size()));
        ...
        for (auto hand : {Side::LEFT, Side::RIGHT}) {
            ...
            if (XR_UNQUALIFIED_SUCCESS(res)) {
                if ((spaceLocation.locationFlags & XR_SPACE_LOCATION_POSITION_VALID_BIT) != 0 &&
                    ...
                    scale = 0.1f * m_input.handScale[hand];
                    cubes.push_back(Cube{spaceLocation.pose, {scale, scale, scale}, true, hand});
                }
            } else {
        ...
        // 是 2
        //Log::Write(Log::Level::Info, Fmt("viewCountOutput: %d", viewCountOutput));
